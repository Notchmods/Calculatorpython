#   Imports.
from tkinter import *
#   (Summary of what second import does).
...
#   Defining the top.
Label(root, text='Calculator', font=(15), bg='Yellow').place(x=25, y=0)
...
multiply = Button(root, height=2, width=5, text='*', font=9, bg='DarkOrange', command=lambda: add_text('*', entry_strvar))
multiply.place(x=195, y=225)
divide = Button(root, height=2, width=5, text='/', font=9, bg='DarkOrange', command=lambda: add_text('/', entry_strvar))
...
equal = Button(root, height=2, width=5, text='=', font=9, bg='DarkOrange', command=lambda: submit(eqn_entry, entry_strvar))
...
AC_btn = Button(root, height=2, width=5, text='AC', font=9, bg='OrangeRed', command=lambda: entry_strvar.set(' '))
